...
public class InspectionDialog extends Dialog {
    ...
    public InspectionDialog(Context context, int theme) {
        super(context, theme);
    }

    protected InspectionDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        public InspectionDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final InspectionDialog dialog = new InspectionDialog(context,R.style.InspectionDialog);
            ...
            if (positiveButtonText != null) {
                if (positiveButtonClickListener != null) {
                    ((ImageView) layout.findViewById(R.id.location_ok))
            ...
            if (negativeButtonText != null) {
                ...
                if (negativeButtonClickListener != null) {
                    ((ImageView) layout.findViewById(R.id.location_cancel))
                            .setOnClickListener(new View.OnClickListener() {
                                public void onClick(View v) {
